...
ALTER TABLE inventory_document_lines ADD CONSTRAINT inventory_document_lines_document_id_inventory_documents_id_fk FOREIGN KEY (document_id) REFERENCES inventory_documents(id) ON DELETE CASCADE;
...
ALTER TABLE inventory_count_lines ADD CONSTRAINT inventory_count_lines_count_id_inventory_counts_id_fk FOREIGN KEY (count_id) REFERENCES inventory_counts(id) ON DELETE CASCADE;
ALTER TABLE inventory_count_lines ADD CONSTRAINT inventory_count_lines_product_id_inventory_products_id_fk FOREIGN KEY (product_id) REFERENCES inventory_products(id) ON DELETE CASCADE;
