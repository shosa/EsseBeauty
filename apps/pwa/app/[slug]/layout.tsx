...
export default async function SalonLayout({ children, params }: { children: ReactNode; params: Promise<{ slug: string }> }) {
  ...
  return <div className="pb-20">{children}<nav className="fixed inset-x-0 bottom-0 z-20 mx-auto grid h-16 max-w-[430px] grid-cols-3 border-t border-stone-200 bg-white/95 text-center text-xs font-semibold backdrop-blur">
