...
export function CompleteRegistrationCard({ prefill, primary }: { prefill: Prefill; primary: string }) {
  ...
  return (
    <section className="animate-slide-up mt-4 rounded-3xl border border-stone-200 bg-white p-6">
      ...
      <form action={submit} className="mt-4 flex flex-col gap-3 sm:flex-row">
        ...
        <button className="min-h-12 shrink-0 rounded-full px-6 font-black text-white disabled:opacity-50" disabled={submitting} style={{ background: primary }} type="submit">
