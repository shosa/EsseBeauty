...
export function WorkspaceTopbar({ actions, app, canViewWhatsApp, onNotificationsOpen, onSearchOpen, onWhatsAppOpen, pathname, tabs, unreadCount, whatsappUnreadCount }: { actions: readonly AppQuickAction[]; app?: AppDefinition; canViewWhatsApp: boolean; onNotificationsOpen(): void; onSearchOpen(): void; onWhatsAppOpen(): void; pathname: string; tabs: readonly AppTab[]; unreadCount: number; whatsappUnreadCount: number }) {
