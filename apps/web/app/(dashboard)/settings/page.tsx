...
export default function GeneralSettingsPage() {
  ...
  async function saveBranding() {
    ...
    setMessage(response.ok ? "Aspetto App Clienti salvato." : "Salvataggio non riuscito.");
  }
  ...
  if (!settings) {
    return <AppPage maxWidth="max-w-[1600px]"><SectionCard><div className="h-96 animate-pulse rounded-2xl bg-stone-100" /></SectionCard></AppPage>;
  }
  ...
  return (
    <AppPage maxWidth="max-w-[1600px]">
      ...
      <PageHeader
        ...
        title="Impostazioni"
        subtitle="Qui si configurano regole, automazioni, agenda, dati e applicazioni collegate."
      />


      <div className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <SectionCard title="Salone" subtitle="Dati principali e orari ufficiali usati dal gestionale e dalle app collegate.">
