      ...
      <div className="grid gap-5 xl:grid-cols-2">
        ...
        <SectionCard title="Aspetto App Clienti" subtitle="Personalizza la home e il percorso di prenotazione.">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <FormField className="md:col-span-2" label="Messaggio dopo la prenotazione (visibile su modalità prenotazione confermata automaticamente)"><textarea className="min-h-28 w-full resize-y" onChange={(event) => setSettings({ ...settings, bookingSuccessText: event.target.value })} value={settings.bookingSuccessText} /></FormField>
