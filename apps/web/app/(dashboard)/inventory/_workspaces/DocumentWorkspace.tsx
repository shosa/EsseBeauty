...
import { AppPage, Button, ConfirmDialog, InlineError, PageHeader } from "@esse-beauty/ui";
  ...
  return (
    <AppPage maxWidth="max-w-[1600px]">
      <PageHeader
        ...
        eyebrow="Magazzino"
        subtitle="Acquisti, rettifiche, scarti e note credito: il registro formale di tutti i movimenti."
        title="Documenti"
      />
