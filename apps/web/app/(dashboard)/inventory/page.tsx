  ...
  return (
    <AppPage>
      <PageHeaderMetrics
        ...
        eyebrow="Magazzino"
        metrics={[
          { detail: "Nel magazzino", label: "Prodotti", value: items.length },
          { detail: "Da reintegrare", label: "Scorte basse", value: lowStockCount },
          { detail: "Valore stimato", label: "Valore scorte", value: (stockValue / 100).toLocaleString("it-IT", { currency: "EUR", style: "currency" }) },
        ]}
