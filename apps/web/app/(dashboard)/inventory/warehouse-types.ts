...
export interface WarehouseProduct { id: string; name: string; sku: string | null; barcode?: string | null; category: string | null; itemType: WarehouseItemType; unit: string; stockQuantity: number; lowStockThreshold: number; reorderQuantity: number; unitPriceCents: number; averageCostCents: number; lastCostCents: number; supplier: string | null; preferredSupplier: string | null; preferredSupplierId: string | null; trackStock: boolean; active: boolean; }
