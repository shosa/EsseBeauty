...
import { Award, ChevronRight, CircleMinus, CirclePlus, Gift, ListChecks, Receipt, Search, TrendingUp, Wallet } from "lucide-react";
    ...
    <AppPage maxWidth="max-w-[1600px]">
      ...
      {loading ? <div className="h-40 animate-pulse rounded-2xl bg-stone-100" /> : <>
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(360px,.75fr)]">
          <SectionCard icon={Search} title="Clienti e saldo" subtitle="Cerca un cliente, controlla la progressione e opera sul saldo.">
          ...
          <SectionCard icon={Wallet} title={customer ? customer.name : "Operazioni cliente"} subtitle={customer ? `${customer.balance} punti disponibili` : "Seleziona un cliente dall’elenco."}>
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-2">
          ...
          <SectionCard icon={Gift} title="Catalogo premi" subtitle="Disponibilità, costo punti e accesso rapido alla modifica.">
            <div className="space-y-2">
         ...
         <SectionCard className="mt-6" icon={ListChecks} title="Regole di accumulo" subtitle="Punti assegnati automaticamente da appuntamenti e vendite reali.">
